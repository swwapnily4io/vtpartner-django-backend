...
#    path('custom_endpoint/', views.CustomEndpointView.as_view(), name='custom-endpoint'),
#    path('get_customer_auth_token/', views.all_services_api.as_view(), name='get_customer_auth_token')
# ]
...
urlpatterns = [
    ...
    path('refresh-token', customer_login.RefreshCustomerTokenView.as_view(), name='validate_customer_token'),
    #Customer Login
