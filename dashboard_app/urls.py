...
urlpatterns = [
    ...
    path('get_handyman_scheduled_bookings_details', views.get_handyman_scheduled_bookings_details, name='get_handyman_scheduled_bookings_details'),
    ...
    path('get_driver_cancel_reasons', views.get_driver_cancel_reasons, name='get_driver_cancel_reasons'),
    path('add_driver_cancel_reason', views.add_driver_cancel_reason, name='add_driver_cancel_reason'),
    path('update_driver_cancel_reason', views.update_driver_cancel_reason, name='update_driver_cancel_reason'),
    ...
    path('get_service_plan_upgrades', views.get_service_plan_upgrades, name='get_service_plan_upgrades'),
    path('add_service_plan_upgrade', views.add_service_plan_upgrade, name='add_service_plan_upgrade'),
